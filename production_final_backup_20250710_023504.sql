...
--
-- Name: vantix_dev; Type: SCHEMA; Schema: -; Owner: neondb_owner
--

CREATE SCHEMA vantix_dev;


ALTER SCHEMA vantix_dev OWNER TO neondb_owner;
...
--
-- Name: customer_files; Type: TABLE; Schema: vantix_dev; Owner: neondb_owner
--

CREATE TABLE vantix_dev.customer_files (
    id integer NOT NULL,
...
ALTER TABLE vantix_dev.customer_files OWNER TO neondb_owner;

--
-- Name: customer_files_id_seq; Type: SEQUENCE; Schema: vantix_dev; Owner: neondb_owner
--

CREATE SEQUENCE vantix_dev.customer_files_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE vantix_dev.customer_files_id_seq OWNER TO neondb_owner;

--
-- Name: customer_files_id_seq; Type: SEQUENCE OWNED BY; Schema: vantix_dev; Owner: neondb_owner
--

ALTER SEQUENCE vantix_dev.customer_files_id_seq OWNED BY vantix_dev.customer_files.id;


--
-- Name: customer_notes; Type: TABLE; Schema: vantix_dev; Owner: neondb_owner
--

CREATE TABLE vantix_dev.customer_notes (
    id integer NOT NULL,
    customer_id character varying(50) NOT NULL,
    content text NOT NULL,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    note_type character varying(50) DEFAULT 'user'::character varying
);


ALTER TABLE vantix_dev.customer_notes OWNER TO neondb_owner;

--
-- Name: customer_notes_id_seq; Type: SEQUENCE; Schema: vantix_dev; Owner: neondb_owner
--

CREATE SEQUENCE vantix_dev.customer_notes_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE vantix_dev.customer_notes_id_seq OWNER TO neondb_owner;

--
-- Name: customer_notes_id_seq; Type: SEQUENCE OWNED BY; Schema: vantix_dev; Owner: neondb_owner
--

ALTER SEQUENCE vantix_dev.customer_notes_id_seq OWNED BY vantix_dev.customer_notes.id;


--
-- Name: customers; Type: TABLE; Schema: vantix_dev; Owner: neondb_owner
--

CREATE TABLE vantix_dev.customers (
    id integer NOT NULL,
    customer_id character varying(50) NOT NULL,
    company_name character varying(255) NOT NULL,
    status character varying(50) DEFAULT 'prospect'::character varying,
    affiliate_partner character varying(100),
    next_step text,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
...
ALTER TABLE vantix_dev.customers OWNER TO neondb_owner;

--
-- Name: customers_id_seq; Type: SEQUENCE; Schema: vantix_dev; Owner: neondb_owner
--

CREATE SEQUENCE vantix_dev.customers_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE vantix_dev.customers_id_seq OWNER TO neondb_owner;

--
-- Name: customers_id_seq; Type: SEQUENCE OWNED BY; Schema: vantix_dev; Owner: neondb_owner
--

ALTER SEQUENCE vantix_dev.customers_id_seq OWNED BY vantix_dev.customers.id;


--
-- Name: users; Type: TABLE; Schema: vantix_dev; Owner: neondb_owner
--

CREATE TABLE vantix_dev.users (
    id integer NOT NULL,
...
ALTER TABLE vantix_dev.users OWNER TO neondb_owner;

--
-- Name: users_id_seq; Type: SEQUENCE; Schema: vantix_dev; Owner: neondb_owner
--

CREATE SEQUENCE vantix_dev.users_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE vantix_dev.users_id_seq OWNER TO neondb_owner;

--
-- Name: users_id_seq; Type: SEQUENCE OWNED BY; Schema: vantix_dev; Owner: neondb_owner
--

ALTER SEQUENCE vantix_dev.users_id_seq OWNED BY vantix_dev.users.id;
...
--
-- Name: customer_files id; Type: DEFAULT; Schema: vantix_dev; Owner: neondb_owner
--

ALTER TABLE ONLY vantix_dev.customer_files ALTER COLUMN id SET DEFAULT nextval('vantix_dev.customer_files_id_seq'::regclass);


--
-- Name: customer_notes id; Type: DEFAULT; Schema: vantix_dev; Owner: neondb_owner
--

ALTER TABLE ONLY vantix_dev.customer_notes ALTER COLUMN id SET DEFAULT nextval('vantix_dev.customer_notes_id_seq'::regclass);


--
-- Name: customers id; Type: DEFAULT; Schema: vantix_dev; Owner: neondb_owner
--

ALTER TABLE ONLY vantix_dev.customers ALTER COLUMN id SET DEFAULT nextval('vantix_dev.customers_id_seq'::regclass);


--
-- Name: users id; Type: DEFAULT; Schema: vantix_dev; Owner: neondb_owner
--

ALTER TABLE ONLY vantix_dev.users ALTER COLUMN id SET DEFAULT nextval('vantix_dev.users_id_seq'::regclass);
...
--
-- Data for Name: customer_files; Type: TABLE DATA; Schema: vantix_dev; Owner: neondb_owner
--

COPY vantix_dev.customer_files (id, customer_id, file_name, file_path, file_type, file_size, created_at) FROM stdin;
\.


--
-- Data for Name: customer_notes; Type: TABLE DATA; Schema: vantix_dev; Owner: neondb_owner
--

COPY vantix_dev.customer_notes (id, customer_id, content, created_at, note_type) FROM stdin;
\.


--
-- Data for Name: customers; Type: TABLE DATA; Schema: vantix_dev; Owner: neondb_owner
--

COPY vantix_dev.customers (id, customer_id, company_name, status, affiliate_partner, next_step, created_at, updated_at, primary_contact, authorized_signer, billing_contact, notes) FROM stdin;
1	dev_only_customer	Development Test Company	prospect	Development	Test Isolation	2025-07-10 02:34:34.29862	2025-07-10 02:34:34.29862	{"name": "Dev Test Contact", "email": "dev@test.com", "phone": "555-DEV-TEST"}	\N	\N	[{"type": "system", "content": "This customer exists only in development environment to test isolation", "timestamp": "2025-07-10T02:34:00.000Z"}]
\.


--
-- Data for Name: users; Type: TABLE DATA; Schema: vantix_dev; Owner: neondb_owner
--

COPY vantix_dev.users (id, name, email, password_hash, auth_provider, created_at, role, two_factor_secret, two_factor_enabled) FROM stdin;
\.
...
--
-- Name: customer_files_id_seq; Type: SEQUENCE SET; Schema: vantix_dev; Owner: neondb_owner
--

SELECT pg_catalog.setval('vantix_dev.customer_files_id_seq', 1, false);


--
-- Name: customer_notes_id_seq; Type: SEQUENCE SET; Schema: vantix_dev; Owner: neondb_owner
--

SELECT pg_catalog.setval('vantix_dev.customer_notes_id_seq', 1, false);


--
-- Name: customers_id_seq; Type: SEQUENCE SET; Schema: vantix_dev; Owner: neondb_owner
--

SELECT pg_catalog.setval('vantix_dev.customers_id_seq', 1, true);


--
-- Name: users_id_seq; Type: SEQUENCE SET; Schema: vantix_dev; Owner: neondb_owner
--

SELECT pg_catalog.setval('vantix_dev.users_id_seq', 1, false);
...
--
-- Name: customer_files customer_files_pkey; Type: CONSTRAINT; Schema: vantix_dev; Owner: neondb_owner
--

ALTER TABLE ONLY vantix_dev.customer_files
    ADD CONSTRAINT customer_files_pkey PRIMARY KEY (id);


--
-- Name: customer_notes customer_notes_pkey; Type: CONSTRAINT; Schema: vantix_dev; Owner: neondb_owner
--

ALTER TABLE ONLY vantix_dev.customer_notes
    ADD CONSTRAINT customer_notes_pkey PRIMARY KEY (id);


--
-- Name: customers customers_customer_id_key; Type: CONSTRAINT; Schema: vantix_dev; Owner: neondb_owner
--

ALTER TABLE ONLY vantix_dev.customers
    ADD CONSTRAINT customers_customer_id_key UNIQUE (customer_id);


--
-- Name: customers customers_pkey; Type: CONSTRAINT; Schema: vantix_dev; Owner: neondb_owner
--
...
--
-- Name: users users_email_key; Type: CONSTRAINT; Schema: vantix_dev; Owner: neondb_owner
--

ALTER TABLE ONLY vantix_dev.users
    ADD CONSTRAINT users_email_key UNIQUE (email);


--
-- Name: users users_pkey; Type: CONSTRAINT; Schema: vantix_dev; Owner: neondb_owner
--
